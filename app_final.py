...
def index():
    try:
        ...
        return render_template('index.html', DEBUG=True, departments=departments, years=years)
    except:
        ...
        if response.status_code == 200:
            ...
            if data:
                ...
                student_data = {
                    ...
                    "CURR_SEM": str(student.get("curr_sem", "")),
...
def api_student_predict():
    try:
        ...
        predictions = {
            "performance_label": str(student.get("PERFORMANCE_LABEL", "medium")).lower(),
            "risk_label": str(student.get("RISK_LABEL", "medium")).lower(),
            "dropout_label": str(student.get("DROPOUT_LABEL", "medium")).lower()
        }
